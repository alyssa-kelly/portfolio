...
super_list = [
['https://www.rottentomatoes.com/browse/tv_series_browse/affiliates:disney_plus~audience:upright~critics:fresh~sort:popular?page=5', 'Disney+', 'TV Show'],
['https://www.rottentomatoes.com/browse/movies_at_home/affiliates:disney_plus~audience:upright~critics:fresh~sort:popular?page=5', 'Disney+', 'Movie']
]
...
df.to_csv('/Users/alyssa/Desktop/data_analysis/project/rotten_tomatoes_disney.csv', sep=',', index=False) 
