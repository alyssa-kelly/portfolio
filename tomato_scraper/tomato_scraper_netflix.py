...
super_list = [
['https://www.rottentomatoes.com/browse/tv_series_browse/affiliates:netflix~audience:upright~critics:fresh~sort:popular?page=5', 'Netflix', 'TV Show'],    
['https://www.rottentomatoes.com/browse/movies_at_home/affiliates:netflix~audience:upright~critics:fresh~sort:popular?page=5', 'Neflix', 'Movie'], 
]
...
df.to_csv('/Users/alyssa/Desktop/data_analysis/project/rotten_tomatoes_netflix.csv', sep=',', index=False) 
